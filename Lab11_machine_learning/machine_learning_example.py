...
# **Note**
# 
# - You can replace `Perceptron(max_iter, ...)` by `Perceptron(max_iter, ...)` in scikit-learn >= 0.19.
...
# **Note**
# 
# - You can replace `Perceptron(max_iter, ...)` by `Perceptron(max_iter, ...)` in scikit-learn >= 0.19. The `max_iter` parameter is used here deriberately, because some people still use scikit-learn 0.18.
